...
Reverse SOCKS5 proxy. A C# agent connects outbound to a Go server, which exposes a local SOCKS5 proxy. Traffic from SOCKS clients is tunneled through the agent to reach the target network.
